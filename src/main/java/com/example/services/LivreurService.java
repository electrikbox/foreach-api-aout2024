...
public class LivreurService {
  ...
  public List<Livreur> getAll(){
   ...
   public int insert(Livreur livreur){
     ...
     return this.jdbcTemplate.update(sql, livreur.getNom(), livreur.getPrenom(), livreur.getTelephone(), livreur.getEmail());
   }

   public int update(Livreur livreur){
     String sql = "UPDATE livreurs set nom=?,prenom=?,email=?,telephone=? WHERE Id=?";
     return this.jdbcTemplate.update(sql, livreur.getNom(), livreur.getPrenom(), livreur.getEmail(), livreur.getTelephone(), livreur.getId());
   }
